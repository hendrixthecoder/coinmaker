<div class="top-0 z-50 left-[-300px] text-white bg-deep-blue shadow-lg duration-500 fixed bottom-0 p-4 w-[290px] overflow-y-auto" id="navMenu">
    ...
    <div class="my-3 flex flex-col gap-6">
        <div class="flex gap-3 hover:text-gray-300 hover:translate-x-4 duration-500 @if (Route::is('userDashboard')) text-blue-900 @endif">
            <span class="material-icons">dashboard</span>
            <a href="{{ route('userDashboard') }}">Dashboard</a>
        </div>
        <div class="flex gap-3 hover:text-gray-300 hover:translate-x-4 duration-500 @if (Route::is('deposits')) text-blue-900 @endif">
