...
@section('content')
    <div class="flex flex-col w-full gap-6 mb-10">
        ...
        <div class="border-b select-none  border-neutral-600 flex space-x-14 pl-10 transition-all duration-500">
            <h2 class="hover:border-b-2 pb-3 text-lg cursor-pointer" data-toggle="pointer" data-toggle-target="account">Account</h2>
            <h2 class="hover:border-b-2 pb-3 text-lg cursor-pointer" data-toggle="pointer" data-toggle-target="security">Security</h2>
        </div>
        ...
        <section aria-describedby="account" data="pointer" class="">
            ...
            <div class="w-full rounded-md p-3 bg-light-blue">
                <form action="{{ route('postUpdateAccount') }}" method="post" class="flex flex-col gap-6 p-2">
                    @csrf
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <select name="country" required id="country" class="p-3 rounded-md bg-deep-blue outline-none">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('[data-toggle-target="account"]').addClass('border-b-2 border-blue-500')
