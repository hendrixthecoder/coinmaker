...
<div class="my-6">
    ...
    @else
        <div class="rounded-md p-5 bg-light-blue flex flex-col gap-4 overflow-auto">
...
<script>
    const openModal = () => {
        let modal = document.querySelector(`#view${event.target.getAttribute('data-toggle-modal')}`)
